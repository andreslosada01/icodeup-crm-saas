...
$env:ICODEUP_TEST_PLATFORM_EMAIL="superadmin@demo.icodeup.local"
$env:ICODEUP_TEST_PLATFORM_PASSWORD="<password_platform_test>"
$env:ICODEUP_TEST_TENANT_ADMIN_EMAIL="admin.andina@demo.icodeup.local"
$env:ICODEUP_TEST_AGENT_EMAIL="gestor1.andina@demo.icodeup.local"
$env:ICODEUP_TEST_LAWYER_EMAIL="abogado.andina@demo.icodeup.local"
$env:ICODEUP_TEST_SALES_EMAIL="comercial.andina@demo.icodeup.local"
...
| `test_specialized_roles.py` | Menus y accesos especializados para abogado, comercial y regresion de agente de cobranzas. |
