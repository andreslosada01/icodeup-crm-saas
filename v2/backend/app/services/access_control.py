...
ROLE_PERMISSION_FALLBACKS = {
    ...
    COORDINATOR: {
        ...
        "typifications.view", "recordings.view", "recordings.playback", "uploads.view", "uploads.repartos.manage", "uploads.demographics.manage", "demographics.view", "excel_web.view", "excel_web.query", "excel_web.sheet.manage",
