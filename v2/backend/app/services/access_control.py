...
ROLE_PERMISSION_FALLBACKS = {
    ...
    TENANT_ADMIN: {
        ...
        "careflow.view", "careflow.create", "careflow.update", "careflow.assign", "careflow.close",
        "careflow.events.create", "careflow.configure", "careflow.reports.view",
        ...
        "excel_web.view", "excel_web.query", "excel_web.export", "excel_web.views.manage", "excel_web.sheet.manage",
    ...
    COORDINATOR: {
        ...
        "typifications.view", "recordings.view", "recordings.playback", "uploads.view", "uploads.preview", "uploads.confirm", "uploads.repartos.manage", "uploads.demographics.manage", "demographics.view", "excel_web.view", "excel_web.query", "excel_web.sheet.manage",
        "telephony.view", "telephony.call", "telephony.logs.view",
        "careflow.view", "careflow.create", "careflow.update", "careflow.assign", "careflow.close",
        "careflow.events.create", "careflow.reports.view",
    ...
    AGENT: {
        ...
        "typifications.view", "demographics.view", "excel_web.view", "excel_web.query", "excel_web.views.manage", "excel_web.sheet.manage",
        "menu.view",
        "alerts.view",
    },
}
