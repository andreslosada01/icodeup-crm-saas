...
MODULE_DEFS = [
    ...
    ("careflow", "CareFlow 360", "Atencion al cliente, casos, solicitudes, SLA y seguimiento.", "business", 0, "life-buoy", 68),
...
PERMISSION_DEFS = [
    ...
    ("contact_compliance.view", "Ver cumplimiento de contacto", "collections"),
    ("contact_compliance.manage", "Configurar reglas de contacto", "collections"),
    ("contact_compliance.evaluate", "Evaluar contacto operativo", "collections"),
    ...
    ("careflow.view", "Ver CareFlow 360", "careflow"),
    ("careflow.create", "Crear casos CareFlow", "careflow"),
    ("careflow.update", "Actualizar casos CareFlow", "careflow"),
    ("careflow.assign", "Asignar responsables CareFlow", "careflow"),
    ("careflow.close", "Cerrar casos CareFlow", "careflow"),
    ("careflow.events.create", "Agregar eventos CareFlow", "careflow"),
    ("careflow.configure", "Configurar CareFlow", "careflow"),
    ("careflow.reports.view", "Ver reportes CareFlow", "careflow"),
...
ROLE_PERMISSION_MAP = {
    ...
    TENANT_ADMIN: [
        ...
        "contact_compliance.view", "contact_compliance.manage", "contact_compliance.evaluate",
        ...
        "careflow.view", "careflow.create", "careflow.update", "careflow.assign", "careflow.close", "careflow.events.create", "careflow.configure", "careflow.reports.view",
    ...
    COORDINATOR: [
        ...
        "careflow.view", "careflow.create", "careflow.update", "careflow.assign", "careflow.close", "careflow.events.create", "careflow.reports.view",
    ...
    QUALITY_SUPERVISOR: [
        ...
        "contact_compliance.view", "contact_compliance.evaluate",
        ...
        "careflow.view", "careflow.events.create", "careflow.reports.view",
    ...
    AGENT: [
        ...
        "telephony.view", "telephony.call", "telephony.logs.view",
        "careflow.view", "careflow.create", "careflow.update", "careflow.close", "careflow.events.create",
...
MENU_DEFS = [
    ...
    ("Cumplimiento y contacto", "contact-compliance", "collections", "contact_compliance.view", "platform_admin", 42),
    ...
    ("Reportes operativos", "reports", "bi", "reports.view", "platform_admin", 48),
    ("Telefonia", "telephony", "telephony", "telephony.view", "platform_admin", 49),
    ("CareFlow Global", "careflow", "careflow", "careflow.view", "platform_admin", 49),
    ("Configuracion CareFlow", "careflow-config", "careflow", "careflow.configure", "platform_admin", 49),
    ...
    ("Cumplimiento y contacto", "contact-compliance", "collections", "contact_compliance.view", "company_admin", 76),
    ("CareFlow 360", "careflow", "careflow", "careflow.view", "company_admin", 77),
    ("Configuracion CareFlow", "careflow-config", "careflow", "careflow.configure", "company_admin", 78),
    ("Reportes CareFlow", "careflow-reports", "careflow", "careflow.reports.view", "company_admin", 79),
    ...
    ("Reportes operativos", "reports", "bi", "reports.view", "company_admin", 110),
    ...
    ("Cumplimiento y contacto", "contact-compliance", "collections", "contact_compliance.view", "operational_leader", 54),
    ("Casos de atencion", "careflow", "careflow", "careflow.view", "operational_leader", 55),
    ("Equipo / seguimiento", "careflow-team", "careflow", "careflow.reports.view", "operational_leader", 56),
    ("Reportes basicos", "careflow-reports", "careflow", "careflow.reports.view", "operational_leader", 57),
    ...
    ("Reportes operativos", "reports", "bi", "reports.view", "operational_leader", 90),
    ...
    ("Mis casos", "careflow", "careflow", "careflow.view", "operational_user", 56),
    ("Crear caso", "careflow-new", "careflow", "careflow.create", "operational_user", 57),
    ("Casos asignados", "careflow-assigned", "careflow", "careflow.view", "operational_user", 58),
